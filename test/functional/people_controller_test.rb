...
=end
  ...
  context "bulk deleting people" do
    ...
    should "not bulk delete when contact ids in the params aren't existing" do
      assert_no_difference "OrganizationalRole.where(organization_id: #{@user.person.organizations.first.id}).count" do
    ...
    should "not bulk delete all the admins in the org" do
      ...
      assert_no_difference "OrganizationalRole.where(organization_id: #{@user.person.organizations.first.id}, role_id: #{Role.admin.id}).count" do
